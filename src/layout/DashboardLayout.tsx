...
import StockMovements from '../components/modals/pages/StockMovements';
  ...
  const renderPageContent = () => {
    switch (selectedKey) {
      ...
      case 'categories':
        return <Categories />;
      case 'users':
        return <div style={{ padding: '24px', textAlign: 'center', color: '#8c8c8c' }}>Page Utilisateurs - À implémenter</div>;
      case 'settings':
        return <Settings />;
      default:
        return <Dashboard />;
